...
class Student extends DataClass implements Insertable<Student> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, name, subject, phone, rate, note, archived, createdAt);
  @override
...
class Lesson extends DataClass implements Insertable<Lesson> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, studentId, startAt, durationMin, price, status, note);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Lesson &&
...
class $PaymentsTable extends Payments with TableInfo<$PaymentsTable, Payment> {
  ...
  @override
  List<GeneratedColumn> get $columns => [id, studentId, amount, paidAt, note];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Payment extends DataClass implements Insertable<Payment> {
  ...
  @override
  int get hashCode => Object.hash(id, studentId, amount, paidAt, note);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Payment &&
...
final class $$StudentsTableReferences
  ...
  static MultiTypedResultKey<$LessonsTable, List<Lesson>> _lessonsRefsTable(
    ...
    db.lessons,
    aliasName: 'students__id__lessons__student_id',
  );
...
class $$StudentsTableTableManager
    extends
        RootTableManager<
          ...
          Student,
          PrefetchHooks Function({bool lessonsRefs, bool paymentsRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({lessonsRefs = false, paymentsRefs = false}) {
            return PrefetchHooks(
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (lessonsRefs)
                    await $_getPrefetchedData<Student, $StudentsTable, Lesson>(
                      currentTable: table,
                      referencedTable: $$StudentsTableReferences
                          ._lessonsRefsTable(db),
                      managerFromTypedResult: (p0) =>
                          $$StudentsTableReferences(db, table, p0).lessonsRefs,
                  ...
                  if (paymentsRefs)
                    await $_getPrefetchedData<Student, $StudentsTable, Payment>(
                      ...
                      managerFromTypedResult: (p0) =>
                          $$StudentsTableReferences(db, table, p0).paymentsRefs,
                      referencedItemsForCurrentItem: (item, referencedItems) =>
                          referencedItems.where((e) => e.studentId == item.id),
                      typedResults: items,
                    ),
...
final class $$LessonsTableReferences
  ...
  static $StudentsTable _studentIdTable(_$AppDatabase db) =>
      db.students.createAlias('lessons__student_id__students__id');
